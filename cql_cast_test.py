...
class CQLCastTest(CqlshPrepare):
    ...
    def cast_issue_3110_test(self):
        ...
        self._test_run(test_from, TestData.POSITIVE_VALUES, test_to=['decimal'],
                       test_types=['cast', 'sum', 'min', 'max', 'cast_min', 'cast_max', 'cast_avg'], exclude=False)
    ...
    def cast_issue_3112_test(self):
        ...
        self._test_run(test_from, TestData.POSITIVE_VALUES, test_to=['double', 'float'],
...
class TestData(object):
    ...
    POSITIVE_VALUES = {
        'bigint': [[7657139128428828644,
                    {'cast': {'tinyint': -28, 'smallint': -26652, 'int': -776038428, 'float': '7.65713916356461e+18', 'double': '7.65713912842883e+18',
                              '#decimal': 7.6571391284288287E+18, 'varint': 7657139128428828644, 'text': '7657139128428828644', 'varchar': '7657139128428828644'},
                    'avg': {'tinyint': 10, 'smallint': -10741, 'int': -258681333, 'float': '2.55237962956223e+18', 'double': '2.55237970947627e+18',
                            'decimal': None, 'varint': 2552379709476274357, 'text': None, 'varchar': None},
                    'sum': {'tinyint': 31, 'smallint': -32225, 'int': -776044001, 'float': '7.65713916356461e+18', 'double': '7.65713912842882e+18',
                    ...
                    'min': {'tinyint': -66, 'smallint': -26652, 'int': -776038428, 'float': -5698, 'double': -5698,
                            '#decimal': None, 'varint': -5698, 'text': '-5698', 'varchar': '-5698'},
                    'max': {'tinyint': 125, 'smallint': 125, 'int': 125, 'float': '7.65713916356461e+18', 'double': '7.65713912842883e+18',
        ...
        'decimal': [[76571.345, {'cast': {'tinyint': 27, 'smallint': 11035, 'int': 76571, 'float': 76571.34375,
                                 ...
                                 'avg': {'tinyint': 14, 'smallint': 5390, 'int': 38158, '#float': 38158.54296875,
                                         '#double': 38158.5440065, 'bigint': 38158, 'varint': 38158, 'text': None,
                                         'varchar': None},
                                 'sum': {'tinyint': 29, 'smallint': 10781, 'int': 76317, 'float': 76317.0859375,
                                         '#double': 76317.088013, 'bigint': 76317, 'varint': 76317, 'text': None,
                                         'varchar': None},
                                 'min': {'tinyint': 2, 'smallint': -254, 'int': -254, '#float': -254.25698852539062,
                                         '#double': -254.25698699999998, 'bigint': -254, 'varint': -254,
                                         'text': '-254.256987',
                                         'varchar': '-254.256987'},
                                 ...
                                 'cast_avg': {'tinyint': 14, 'smallint': -27378, 'int': 38158,
                                              '#float': '38158.54296875',
                                              '#double': '38158.544006500000251', 'bigint': 38158, 'varint': 38158,
                                              'text': None,
                                              'varchar': None},
                                 'cast_sum': {'tinyint': 29, 'smallint': 10781, 'int': 76317,
                                              '#float': '76317.0859375',
                                              'double': '76317.088013000000501', 'bigint': 76317, 'varint': 76317,
                                              'text': None,
                                              'varchar': None},
                                 'cast_min': {'tinyint': 2, 'smallint': -254, 'int': -254,
                                              'float': '-254.256988525390625',
                                              '#double': '-254.256987000000009', 'bigint': -254, 'varint': -254,
                                              'text': '-254.256987', 'varchar': '-254.256987'},
                                 'cast_max': {'tinyint': 27, 'smallint': 11035, 'int': 76571, 'float': 76571.34375,
                                              'double': '76571.345000000001164', 'bigint': 76571, 'varint': 76571,
                                              'text': '76571.345', 'varchar': '76571.345'},
                                 'cast_cast': {'double/bigint': '76571'}}],
                    [-254.256987,
                     {'cast': {'tinyint': 2, 'smallint': -254, 'int': -254, '#float': -254.25698852539062,
                               '#double': -254.25698699999998, 'bigint': -254, 'varint': -254, 'text': '-254.256987',
                               'varchar': '-254.256987'}}]
                    ],
        'double': [[76571.345, {'cast': {'tinyint': 27, 'smallint': 11035, 'int': 76571, 'float': 76571.34375,
                                 ...
                                 'max': {'tinyint': 27, 'smallint': 11035, 'int': 76571, 'float': 76571.34375,
                                         'decimal': '76571.345000000001', 'bigint': 76571, 'varint': 76571,
                                         '#text': '76571.345', '#varchar': '76571.345'}}],
                    [-254.256987, {'cast': {'tinyint': 2, 'smallint': -254, 'int': -254, '#float': -254.25698852539062,
                                            'decimal': '-254.25698700000001', 'bigint': -254, 'varint': -254,
                                            '#text': '-254.256987', '#varchar': '-254.256987'}}]
                    ],
        'float': [[-564, {'cast': {'tinyint': -52, 'smallint': -564, 'int': -564, 'double': -564, '#decimal': '-564.0',
                                   'bigint': -564, 'varint': -564, '#text': '-564.0', '#varchar': '-564.0'},
                                'avg': {'tinyint': 10, 'smallint': 1034, 'int': 1034, 'double': '1034.238825480143305',
                                        '#decimal': '1034.23882548014323', 'bigint': 1034, 'varint': 1034,
                                        'text': None, 'varchar': None},
                                'sum': {'tinyint': 30, 'smallint': 3102, 'int': 3102, 'double': '3102.716476440429688',
                                        '#decimal': '3102.71647644042969', 'bigint': 3102, 'varint': 3102,
                                        'text': None, 'varchar': None},
                                'min': {'tinyint': -52, 'smallint': -564, 'int': -564, 'double': -564, '#decimal': '-564.0',
                                        'bigint': -564, 'varint': -564, '#text': '-564.0', '#varchar': '-564.0'},
                                'max': {'tinyint': 123, 'smallint': 3543, 'int': 3543, 'double': '3543.45654296875',
                                        '#decimal': '3543.45654296875', 'bigint': 3543, 'varint': 3543,
                                        '#text': '3543.4565', '#varchar': '3543.4565'}}],
                    [3543.4565429688, {'cast': {'tinyint': -41, 'smallint': 3543, 'int': 3543, '#double': 3543.4565429688,
                                                '#decimal': '3543.45654296875', 'bigint': 3543, 'varint': 3543,
                                                '#text': '3543.4565', '#varchar': '3543.4565'}}],
                    ['123.25993624886543132316548678', {'cast': {'tinyint': 123, 'smallint': 123, 'int': 123, 'double': '123.259933471679688',
                                                '#decimal': '123.25993347167969', 'bigint': 123, 'varint': 123,
                                                '#text': '123.25993', '#varchar': '123.25993'}}]
                   ],
        'int': [[0, {'cast': {'tinyint': 0, 'smallint': 0, 'float': 0, 'double': 0, '#decimal': '0.0', 'bigint': 0, 'varint': 0,
                                'text': '0', 'varchar': '0'},
                            'avg': {'tinyint': 3, 'smallint': -2044, '#float': -2044.4000244141, '#double': -2044.4,
        ...
        'tinyint': [
            [127, {'cast': {'smallint': 127, 'int': 127, 'float': 127, 'double': 127, '#decimal': '127.0',
                     ...
                     'avg': {'smallint': 11, 'int': 11, '#float': 11.333333015441895, '#double': 11.333333333333334,
                             '#decimal': '11.333333333333334', 'bigint': 11, 'varint': 11, 'text': None, 'varchar': None},
        ...
        'varint': [[32767456456456456456545678943512357658768763546575675,
                    {'cast': {'tinyint': 59, 'smallint': 9019, 'int': -1446698181, 'float': 'Infinity',
                              '#double': 3.27674564564565e+52, '#decimal': '3.2767456456456457E+52',
                     ...
                     'avg': {'tinyint': -9, 'smallint': 8011, 'int': -678398815, 'float': 'NaN',
                             'double': '1419.333333333333258',
                             'decimal': None, 'bigint': -2110054580, 'text': None, 'varchar': None},
                     'sum': {'tinyint': -29, 'smallint': 24035, 'int': -2035196445, 'float': 'NaN', 'double': 4258,
                             '#decimal': '4258.0', 'bigint': -6330163741, 'text': None, 'varchar': None},
                     ...
                     'cast_avg': {'tinyint': 76, 'smallint': 8012, 'int': -2110054580, 'float': -2110054528,
                                  'double': -2110054580, '#decimal': '-2.11005458E+9', 'bigint': -2110054580,
                                  'text': None, 'varchar': None},
                     'cast_sum': {'tinyint': -29, 'smallint': 24035, 'int': -2035196445, 'float': -6330163712,
                                  'double': -6330163741, '#decimal': '-6330163741', 'bigint': -6330163741,
                                  'text': None, 'varchar': None},
                     ...
                     'cast_max': {'tinyint': 59, 'smallint': 9019, 'int': -1446698181, 'float': 'Infinity',
                                  '#double': 3.2767456456456457e+52, '#decimal': '3.2767456456456457E+52',
                                  'bigint': -4832518953173179589,
                                  'text': '32767456456456456456545678943512357658768763546575675',
                                  'varchar': '32767456456456456456545678943512357658768763546575675'}
                     }],
        ...
        'date':[["\'2017-11-25\'", {'cast': {'timestamp': '2017-11-25 00:00:00+0000'},
                                '#min':  {'timestamp': '-62167219200000'},
                                '#max':  {'timestamp': '2017-11-25 00:00:00+0000'}
                               }],
                ["\'00-01-01\'", {'cast':  {'timestamp': '-62167219200000'}}],
                ["\'1458-12-13\'", {'cast':  {'timestamp': 'datetime.datetime(1458, 12, 13, 0, 0)'}}]
               ],
        ...
        'udt':  {'bigint': [[4561313648948, {'cast': {'decimal': '4561313648948', 'text': '4561313648948'},
                                              'avg': {'#decimal': '2280656551235.0', 'text': None},
                                              'sum': {'#decimal': '4561313102470.0', 'text': None},
                                              'min': {'#decimal': '-546478.0', 'text': '-546478'},
                                              'max': {'decimal': '4561313648948', 'text': '4561313648948'},
                                              'cast_avg': {'decimal': '2280656551235', 'text': '2280656551235'},
                 ...
                 'float': [[55646.234556984, {'cast': {'int': 55646, 'double': '55646.234375'}}]],
