...
class TestUserTypes(Tester):
    ...
    def test_type_keyspace_permission_isolation(self):
        ...
        user1_session = self.patient_cql_connection(node1, user='ks1_user', password='cassandra', default_timeout=60)
        user2_session = self.patient_cql_connection(node1, user='ks2_user', password='cassandra', default_timeout=60)
