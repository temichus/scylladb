...
class TestScyllaUnsupported(Tester):

    @pytest.mark.skip('unimplemented')
    def test_unsupported_feature_cql_counters(self):
        """ Check that a create table with counter returns an informative error """
        raise NotImplementedError

    @pytest.mark.skip('unimplemented')
    def test_unsupported_feature_cql_secondary_index(self):
        """ Check that a create index returns an informative error """
        raise NotImplementedError

    @pytest.mark.skip('unimplemented')
    def test_unsupported_feature_cql_user_type(self):
        """ Check that a create type returns an informative error """
        raise NotImplementedError

    @pytest.mark.skip('unimplemented')
    def test_unsupported_feature_cql_lwt(self):
        """
