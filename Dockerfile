...
RUN sudo dnf -y install redhat-rpm-config redhat-lsb-core python2 python3-devel rsyslog cyrus-sasl iproute docker-ce-cli iptables-services openssl-devel libffi-devel libev libev-devel java-11-openjdk-headless tcpdump && sudo dnf clean all
