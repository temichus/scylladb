...
# code adapted from https://github.com/apache/cassandra/blob/trunk/pylib/cqlshlib/formatting.py
# removed all color related stuff, since we only need it for testing cqlsh copy from CSV
