...
class JsonFullRowInsertSelect(Tester):
    ...
    def simple_schema_test(self):
        ...
        Query rows normally and make sure they look ok there too:
            ...
            ------+------+------------+------------+------------+-------------+------------+-------+--------------------+------------+-------+--------+-----------+-------+---------------------------------+--------------------------------------+--------------------------------------+------+----------------------
              bar |  bar | 1234.45678 | 9.8712e+07 | 9.8712e+07 | -2147483648 | 2147483648 |  True | 13:07:45.089000000 | 2017-11-25 |   123 | 0x0011 | 127.0.0.1 | blarg | 2011-02-02 19:05:00.000000+0000 | 0ad6dfb6-7a6e-11e4-bc39-b4b6763e9d6f | bdf5e8ac-a75e-4321-9ac8-938fc9576c4a | bleh | -9223372036854775808
