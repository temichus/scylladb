...
class ManagerBackupMixin:
    ...
    def _wait_until_node_reaches_status(self, node: ScyllaNode, functioning_node: ScyllaNode, desirable_status: str,
                                        tolerate_missing: bool, timeout: int = 100, step: int = 1):
        """
